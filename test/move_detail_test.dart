...
// tests for MoveDetail
void main() {
  final MoveDetail? instance = /* MoveDetail(...) */ null;
  ...
  group(MoveDetail, () {
    ...
    // int effectChance
    test('to test the property `effectChance`', () async {
      // TODO
    });

    // int pp
    test('to test the property `pp`', () async {
      // TODO
    });
    ...
    test('to test the property `contestCombos`', () async {
      // TODO
    });
    ...
    test('to test the property `contestEffect`', () async {
      // TODO
    });

    // MoveDamageClassSummary damageClass
    test('to test the property `damageClass`', () async {
      // TODO
    });
    ...
    test('to test the property `effectChanges`', () async {
      // TODO
    });
    ...
    test('to test the property `pastValues`', () async {
      // TODO
    });

    // List<MoveDetailStatChangesInner> statChanges
    test('to test the property `statChanges`', () async {
      // TODO
    });

    // SuperContestEffectSummary superContestEffect
    test('to test the property `superContestEffect`', () async {
      // TODO
    });
    ...
    test('to test the property `machines`', () async {
      // TODO
    });

    // List<MoveFlavorText> flavorTextEntries
    test('to test the property `flavorTextEntries`', () async {
      // TODO
    });

    // List<AbilityDetailPokemonInnerPokemon> learnedByPokemon
    test('to test the property `learnedByPokemon`', () async {
      // TODO
    });
  });
}
