...
try {
    final response = api.berryFirmnessList(limit, offset, q);
    print(response);
...
try {
    final response = api.berryFirmnessRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BerriesApi->berryFirmnessRetrieve: $e\n');
}
```
...
try {
    final response = api.berryFlavorList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BerriesApi->berryFlavorList: $e\n');
}
```
...
try {
    final response = api.berryFlavorRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BerriesApi->berryFlavorRetrieve: $e\n');
}
```
...
try {
    final response = api.berryList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BerriesApi->berryList: $e\n');
}
```
...
try {
    final response = api.berryRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BerriesApi->berryRetrieve: $e\n');
}
```
