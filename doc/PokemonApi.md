...
final api = Pokeapi().getPokemonApi();
...
try {
    final response = api.abilityList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->abilityList: $e\n');
}
```
...
try {
    final response = api.abilityRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->abilityRetrieve: $e\n');
}
```
...
try {
    final response = api.characteristicList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->characteristicList: $e\n');
}
```
...
try {
    final response = api.characteristicRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->characteristicRetrieve: $e\n');
}
```
...
try {
    final response = api.eggGroupList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->eggGroupList: $e\n');
}
```
...
try {
    final response = api.eggGroupRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->eggGroupRetrieve: $e\n');
}
```
...
try {
    final response = api.genderList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->genderList: $e\n');
}
```
...
try {
    final response = api.genderRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->genderRetrieve: $e\n');
}
```
...
try {
    final response = api.growthRateList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->growthRateList: $e\n');
}
```
...
try {
    final response = api.growthRateRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->growthRateRetrieve: $e\n');
}
```
...
try {
    final response = api.moveDamageClassList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->moveDamageClassList: $e\n');
}
```
...
try {
    final response = api.moveDamageClassRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->moveDamageClassRetrieve: $e\n');
}
```
...
try {
    final response = api.natureList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->natureList: $e\n');
}
```
...
try {
    final response = api.natureRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->natureRetrieve: $e\n');
}
```
...
try {
    final response = api.pokeathlonStatList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokeathlonStatList: $e\n');
}
```
...
try {
    final response = api.pokeathlonStatRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokeathlonStatRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonColorList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonColorList: $e\n');
}
```
...
try {
    final response = api.pokemonColorRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonColorRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonFormList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonFormList: $e\n');
}
```
...
try {
    final response = api.pokemonFormRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonFormRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonHabitatList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonHabitatList: $e\n');
}
```
...
try {
    final response = api.pokemonHabitatRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonHabitatRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonList: $e\n');
}
```
...
try {
    final response = api.pokemonRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonShapeList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonShapeList: $e\n');
}
```
...
try {
    final response = api.pokemonShapeRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonShapeRetrieve: $e\n');
}
```
...
try {
    final response = api.pokemonSpeciesList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonSpeciesList: $e\n');
}
```
...
try {
    final response = api.pokemonSpeciesRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->pokemonSpeciesRetrieve: $e\n');
}
```
...
try {
    final response = api.statList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->statList: $e\n');
}
```
...
try {
    final response = api.statRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->statRetrieve: $e\n');
}
```
...
try {
    final response = api.typeList(limit, offset, q);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->typeList: $e\n');
}
```
...
try {
    final response = api.typeRetrieve(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling PokemonApi->typeRetrieve: $e\n');
}
```
