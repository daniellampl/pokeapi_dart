...
class LocationApi {
  ...
  Future<Response<PaginatedLocationAreaSummaryList>> locationAreaList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedLocationAreaSummaryList,
                  PaginatedLocationAreaSummaryList>(
              rawData, 'PaginatedLocationAreaSummaryList',
              growable: true);
  ...
  Future<Response<LocationAreaDetail>> locationAreaRetrieve({
    ...
    final _path =
        r'/api/v2/location-area/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<LocationAreaDetail, LocationAreaDetail>(
              rawData, 'LocationAreaDetail',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedLocationSummaryList>> locationList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedLocationSummaryList,
                  PaginatedLocationSummaryList>(
              rawData, 'PaginatedLocationSummaryList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<LocationDetail>> locationRetrieve({
    ...
    final _path =
        r'/api/v2/location/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<LocationDetail, LocationDetail>(
              rawData, 'LocationDetail',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedPalParkAreaSummaryList>> palParkAreaList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedPalParkAreaSummaryList,
                  PaginatedPalParkAreaSummaryList>(
              rawData, 'PaginatedPalParkAreaSummaryList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<PalParkAreaDetail>> palParkAreaRetrieve({
    ...
    final _path =
        r'/api/v2/pal-park-area/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PalParkAreaDetail, PalParkAreaDetail>(
              rawData, 'PalParkAreaDetail',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedRegionSummaryList>> regionList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedRegionSummaryList, PaginatedRegionSummaryList>(
              rawData, 'PaginatedRegionSummaryList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<RegionDetail>> regionRetrieve({
    ...
    final _path =
        r'/api/v2/region/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<RegionDetail, RegionDetail>(rawData, 'RegionDetail',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
