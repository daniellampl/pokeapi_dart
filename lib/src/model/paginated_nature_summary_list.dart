...
class PaginatedNatureSummaryList {
  ...
  final List<NatureSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedNatureSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedNatureSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedNatureSummaryListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedNatureSummaryListToJson(this);
