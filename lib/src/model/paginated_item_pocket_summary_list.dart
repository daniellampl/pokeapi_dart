...
class PaginatedItemPocketSummaryList {
  ...
  final List<ItemPocketSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedItemPocketSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedItemPocketSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedItemPocketSummaryListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedItemPocketSummaryListToJson(this);
