...
class PaginatedContestTypeSummaryList {
  ...
  final List<ContestTypeSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedContestTypeSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedContestTypeSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedContestTypeSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedContestTypeSummaryListToJson(this);
