...
class PaginatedPokemonFormSummaryList {
  ...
  final List<PokemonFormSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedPokemonFormSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedPokemonFormSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedPokemonFormSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedPokemonFormSummaryListToJson(this);
