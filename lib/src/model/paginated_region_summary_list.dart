...
class PaginatedRegionSummaryList {
  ...
  final List<RegionSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedRegionSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedRegionSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedRegionSummaryListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedRegionSummaryListToJson(this);
