...
EvolutionTriggerDetail _$EvolutionTriggerDetailFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = EvolutionTriggerDetail(
          ...
          names: $checkedConvert(
              ...
              (v) => (v as List<dynamic>)
                  .map((e) =>
                      EvolutionTriggerName.fromJson(e as Map<String, dynamic>))
                  .toList()),
...
Map<String, dynamic> _$EvolutionTriggerDetailToJson(
        EvolutionTriggerDetail instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
