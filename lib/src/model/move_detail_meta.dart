...
class MoveDetailMeta {
  /// Returns a new [MoveDetailMeta] instance.
  MoveDetailMeta({
  ...
  factory MoveDetailMeta.fromJson(Map<String, dynamic> json) =>
      _$MoveDetailMetaFromJson(json);

  Map<String, dynamic> toJson() => _$MoveDetailMetaToJson(this);
