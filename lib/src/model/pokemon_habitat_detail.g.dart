...
PokemonHabitatDetail _$PokemonHabitatDetailFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = PokemonHabitatDetail(
          ...
          names: $checkedConvert(
              ...
              (v) => (v as List<dynamic>)
                  .map((e) =>
                      PokemonHabitatName.fromJson(e as Map<String, dynamic>))
                  .toList()),
...
Map<String, dynamic> _$PokemonHabitatDetailToJson(
        PokemonHabitatDetail instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
