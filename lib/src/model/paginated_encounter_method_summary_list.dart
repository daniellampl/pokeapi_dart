...
class PaginatedEncounterMethodSummaryList {
  ...
  final List<EncounterMethodSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedEncounterMethodSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedEncounterMethodSummaryList.fromJson(
          Map<String, dynamic> json) =>
      _$PaginatedEncounterMethodSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedEncounterMethodSummaryListToJson(this);
