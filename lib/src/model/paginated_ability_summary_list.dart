...
class PaginatedAbilitySummaryList {
  ...
  final List<AbilitySummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedAbilitySummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedAbilitySummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedAbilitySummaryListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedAbilitySummaryListToJson(this);
