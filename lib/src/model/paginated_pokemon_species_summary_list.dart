...
class PaginatedPokemonSpeciesSummaryList {
  ...
  final List<PokemonSpeciesSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedPokemonSpeciesSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedPokemonSpeciesSummaryList.fromJson(
          Map<String, dynamic> json) =>
      _$PaginatedPokemonSpeciesSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedPokemonSpeciesSummaryListToJson(this);
