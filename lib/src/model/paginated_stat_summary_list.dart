...
class PaginatedStatSummaryList {
  ...
  final List<StatSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedStatSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedStatSummaryList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedStatSummaryListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedStatSummaryListToJson(this);
