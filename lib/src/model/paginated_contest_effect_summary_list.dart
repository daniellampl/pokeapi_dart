...
class PaginatedContestEffectSummaryList {
  ...
  final List<ContestEffectSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedContestEffectSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedContestEffectSummaryList.fromJson(
          Map<String, dynamic> json) =>
      _$PaginatedContestEffectSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedContestEffectSummaryListToJson(this);
