...
MoveTargetDescription _$MoveTargetDescriptionFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = MoveTargetDescription(
...
Map<String, dynamic> _$MoveTargetDescriptionToJson(
    MoveTargetDescription instance) {
