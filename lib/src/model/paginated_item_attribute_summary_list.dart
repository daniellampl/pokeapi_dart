...
class PaginatedItemAttributeSummaryList {
  ...
  final List<ItemAttributeSummary>? results;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaginatedItemAttributeSummaryList &&
          other.count == count &&
          other.next == next &&
  ...
  factory PaginatedItemAttributeSummaryList.fromJson(
          Map<String, dynamic> json) =>
      _$PaginatedItemAttributeSummaryListFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaginatedItemAttributeSummaryListToJson(this);
